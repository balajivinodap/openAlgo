function varargout = rsiRavi(price,rsiM,rsiThresh,rsiType,raviF,raviS,raviD,raviM,raviE, ...
                             raviThresh, scaling,cost,bigPoint,hSub)
%RSIRAVI RSI signal generation with a RAVI based transformer
...
[srsi,~,~,ri] = rsiMETS(price,rsiM,rsiThresh,rsiType,scaling,cost,bigPoint);
...
if nargout == 0
    ...
    layout = ['3';'2';'1';'3';'5'];
    hSub = cellstr(layout);
    rsiMETS(price,rsiM,rsiThresh,rsiType,scaling,cost,bigPoint,hSub);
    
    layout = ['3';'2';'4'];
    hSub = cellstr(layout);
    ravi(price,raviF,raviS,raviD,raviM,hSub);
