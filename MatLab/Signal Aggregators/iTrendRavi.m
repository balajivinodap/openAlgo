function varargout = iTrendRavi(price,raviF,raviS,raviD,raviM,raviE,raviThresh,scaling,cost,bigPoint,hSub)
%ITRENDRAVI iTrend signal generation with a RAVI based transformer
...
siTrend = iTrendMETS(price,scaling,cost,bigPoint);
...
if nargout == 0
    ...
    hSub = cellstr(layout);
    iTrendMETS(price,scaling,cost,bigPoint,hSub);
