function varargout = maRavi(price,maF,maS,typeMA,raviF,raviS,raviD,raviM,raviE,raviThresh,scaling,cost,bigPoint)
%MARAVI 2 inputs MA signal generation with a RAVI based transformer
