// numTicksProfitSigCPP.cpp : Defines the entry point for the console application.
...
//
// Matlab MEX function:
// [barsOut,sigOut,sharpeOut] = numTicksProfitSigCPP_mex(barsIn,sigIn,sharpeIn,minTick,numTicks,openAvg)
// 
// Inputs:
